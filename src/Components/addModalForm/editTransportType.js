...
const EditTransportTypeModal = ({ isopen, onClose, typeId, englishData, russianData, turkishData, turkmenData }) => {
  ...
  const handleSave = async () => {
    try {
      await editTransportTypes(typeId, english, russian, turkish, turkmen);
      setEnglish('');
      setRussian('');
      setTurkish('');
      setTurkmen('');
